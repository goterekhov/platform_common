...
func (m *transactionManager) transaction(ctx context.Context, opts pgx.TxOptions, fn db.Handler) (err error) {
...
func (m *transactionManager) ReadCommitted(ctx context.Context, f db.Handler) error {
